  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3 sm:gap-4 sm:px-6 lg:px-8">
        ...
        <nav
          className="hidden min-w-0 flex-1 flex-nowrap items-center justify-center gap-4 xl:flex"
        ...
        <span className="mx-2 hidden h-5 w-px shrink-0 bg-gray-200 xl:block" aria-hidden />

        <div className="flex shrink-0 items-center gap-2 sm:gap-3">
          <button
            type="button"
            onClick={() => setMenuOpen(!menuOpen)}
            className="xl:hidden rounded-lg p-2 text-gray-600 transition hover:bg-gray-100 hover:text-gray-900"
            aria-label="Menu"
          ...
          <Link
            href="/register"
            className="hidden min-h-[40px] items-center justify-center rounded-xl px-4 py-2 text-sm font-semibold transition duration-200 ease-out xl:inline-flex"
            style={{
      ...
      {menuOpen ? (
        <div className="xl:hidden border-t border-gray-100 bg-white backdrop-blur-xl">
