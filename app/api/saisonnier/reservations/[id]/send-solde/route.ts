  ...
  try {
    ...
    const emailHtml = wrapLocavioEmail(
      [
        ...
        emailParagraph(
          `Nous avons bien enregistré votre paiement du solde pour votre séjour à <strong style="color:#1a0533;">${logementNom}</strong>. Veuillez trouver votre reçu en pièce jointe.`,
        ),
    ...
    const emailResult = await resend.emails.send({
      ...
      to: [to],
      subject: `Reçu de paiement — Solde séjour à ${logementNom}`,
      html: emailHtml,
