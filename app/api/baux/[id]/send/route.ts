  ...
  try {
    ...
    const emailHtml = wrapLocavioEmail(
      [
        emailGreeting(),
        emailParagraph(
          `Veuillez trouver en pièce jointe le contrat de bail d'habitation concernant : <strong style="color:#1a0533;">${adresseSujet}</strong>.`,
        ),
        emailParagraph(
          "Ce document est adressé au bailleur et au(x) locataire(s) pour conservation.",
        ),
